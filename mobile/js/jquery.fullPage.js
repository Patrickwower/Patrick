		...
		*/
		function createSlideArrows(section){
			...
			if(options.controlArrowColor!='#fff'){
				section.find('.fp-controlArrow.fp-next').css({"width":"20px","height":"20px","background":"#fff"});
				section.find('.fp-controlArrow.fp-prev').css({"width":"20px","height":"20px","background":"#fff"});
			}
